...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! express */ \"express\");\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(express__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _models_User__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/User */ \"./models/User.js\");\n/* harmony import */ var _models_User__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_models_User__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _models_Menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/Menu */ \"./models/Menu.js\");\n/* harmony import */ var _models_Menu__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_models_Menu__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _middleware_authMiddleware__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../middleware/authMiddleware */ \"./middleware/authMiddleware.js\");\n/* harmony import */ var _utils_verifyToken__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/verifyToken */ \"./utils/verifyToken.js\");\n\n\n\n\n\nvar router = express__WEBPACK_IMPORTED_MODULE_0___default.a.Router();\nrouter.get('/', _middleware_authMiddleware__WEBPACK_IMPORTED_MODULE_3__[\"isAuthenticated\"], function (req, res) {\n  var token = req.headers.authorization;\n\n  var _decodeToken = Object(_utils_verifyToken__WEBPACK_IMPORTED_MODULE_4__[\"decodeToken\"])(token),\n      id = _decodeToken.id;\n\n  _models_User__WEBPACK_IMPORTED_MODULE_1___default.a.findById(id).populate('menus').then(function (user) {\n    res.status(200).json({\n      user: user\n    });\n  })[\"catch\"](function (err) {\n    return res.status(400).json(err);\n  });\n});\nrouter.post('/createMenu', _middleware_authMiddleware__WEBPACK_IMPORTED_MODULE_3__[\"isAuthenticated\"], function (req, res, next) {\n  var token = req.headers.authorization;\n\n  var _decodeToken2 = Object(_utils_verifyToken__WEBPACK_IMPORTED_MODULE_4__[\"decodeToken\"])(token),\n      id = _decodeToken2.id;\n\n  _models_User__WEBPACK_IMPORTED_MODULE_1___default.a.findById(id).then(function () {\n    var _req$body = req.body,\n        name = _req$body.name,\n        dishes = _req$body.dishes;\n    var newMenu = new _models_Menu__WEBPACK_IMPORTED_MODULE_2___default.a({\n      name: name,\n      dishes: dishes,\n      userId: id\n    });\n    newMenu.save().then(function () {\n      return res.status(201).json(newMenu);\n    })[\"catch\"](next);\n  })[\"catch\"](function (err) {\n    return res.status(400).json(err);\n  });\n});\n/* harmony default export */ __webpack_exports__[\"default\"] = (router);\n\n//# sourceURL=webpack:///./routes/menu.js?");
